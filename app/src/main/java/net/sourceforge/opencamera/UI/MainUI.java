...
public class MainUI {
    ...
    private void layoutUI(boolean popup_container_only) {
		...
		int start_of = RelativeLayout.START_OF;
		...
		if( !popup_container_only )
		{
			...
			/*layoutParam.addRule(align_parent_left, 0);
			layoutParam.addRule(align_parent_right, RelativeLayout.TRUE);
			layoutParam.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParam.addRule(align_parent_bottom, 0);
			layoutParam.addRule(left_of, 0);
			layoutParam.addRule(right_of, 0);*/
			...
			/*layoutParam.addRule(align_parent_top, 0);
			layoutParam.addRule(align_parent_bottom, RelativeLayout.TRUE);
			layoutParam.addRule(start_of, R.id.gui_anchor);
			layoutParam.addRule(right_of, 0);*/
			view.setLayoutParams(layoutParam);
			setViewRotation(view, ui_rotation);
			...
			/*layoutParam.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParam.addRule(align_parent_bottom, 0);
			layoutParam.addRule(left_of, R.id.settings);
			layoutParam.addRule(right_of, 0);*/
			view.setLayoutParams(layoutParam);
			setViewRotation(view, ui_rotation);
			...
			/*layoutParam.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParam.addRule(align_parent_bottom, 0);
			layoutParam.addRule(left_of, R.id.popup);
			layoutParam.addRule(right_of, 0);*/
			view.setLayoutParams(layoutParam);
			setViewRotation(view, ui_rotation);
			...
			/*layoutParam.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParam.addRule(align_parent_bottom, 0);
			layoutParam.addRule(left_of, R.id.exposure_lock);
			layoutParam.addRule(right_of, 0);*/
			view.setLayoutParams(layoutParam);
			setViewRotation(view, ui_rotation);
			...
			view = main_activity.findViewById(R.id.video_transparent_background);
			layoutParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
			layoutParams.addRule(align_parent_left, 0);
			...
			//Tools Container
			view = main_activity.findViewById(R.id.tools_container);
			layoutParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
			layoutParams.addRule(align_parent_left, 0);
			layoutParams.addRule(align_parent_right, RelativeLayout.TRUE);
			layoutParams.addRule(align_parent_top, 0);
			layoutParams.addRule(align_parent_bottom, RelativeLayout.TRUE);
			layoutParams.setMargins(0,0,(int) (110 * scale + 0.5f),0);
			layoutParams.setMargins(0,0,(int) (110 * scale + 0.5f),0);
			view.setLayoutParams(layoutParams);
			...
			layoutParams.addRule(align_parent_left, 0);
			layoutParams.addRule(align_parent_right, RelativeLayout.TRUE);
			layoutParams.setMargins(0, 0, (int) (28 * scale + 0.5f), (int) (6 * scale + 0.5f));
			view.setLayoutParams(layoutParams);
			setViewRotation(view, ui_rotation);
